...
> Current release: `v0.3.1`. The project is still moving quickly. APIs, packaging, runtime distribution, and UI details may continue to change.
...
- macOS Apple Silicon DMG: `Hermes.Agent.CN.Desktop_0.3.1_aarch64.dmg`
- macOS Intel DMG: `Hermes.Agent.CN.Desktop_0.3.1_x64.dmg`
- Windows x64 installer: `Hermes.Agent.CN.Desktop_0.3.1_x64-setup.exe`
