...
> Current release: `v0.2.0`. The project is still in alpha. APIs, packaging, runtime distribution, and UI details may change before the first stable release.
...
- macOS Apple Silicon DMG: `Hermes.Agent.CN.Desktop_0.2.0_aarch64.dmg`
- Windows x64 installer: `Hermes.Agent.CN.Desktop_0.2.0_x64-setup.exe`
