...
Hermes Agent CN Desktop 是 Hermes Agent 中文社区推出的桌面客户端，原生支持Windows与MacOS系统。项目基于 [Tauri v2](https://v2.tauri.app/)、Rust、React 和 TypeScript 构建，包含 [Hermes-CN-Core](https://github.com/Eynzof/Hermes-CN-Core) 中文社区修改版的 Hermes Agent 内核。

> 当前版本是 `v0.2.3`。项目仍处于 alpha 阶段，API、打包流程、运行时分发策略和界面细节都可能在稳定版发布前继续调整。
...
- Windows x64 安装器：`Hermes.Agent.CN.Desktop_0.2.3_x64-setup.exe`
