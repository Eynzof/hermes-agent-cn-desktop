...
export const configOptionTranslations: Record<string, string> = {
  ...
  "approvals.mode::manual": "默认手动审批",
  "approvals.mode::default": "默认手动审批",
  "approvals.mode::ask": "默认手动审批",
  "approvals.mode::smart": "Smart 智能审批",
  "approvals.mode::yolo": "YOLO 全部放行",
  "approvals.mode::off": "YOLO 全部放行",
